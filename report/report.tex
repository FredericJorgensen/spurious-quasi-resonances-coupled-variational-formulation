...
\begin{figure}
    %validate_p_c_i1.0c_o3.0N_100plotRangeStart_4.0plotRangeEnd_8.0
    \includegraphics[width=0.5\textwidth]{validate_p_1.pdf}
    %validate_p_c_i3.0c_o1.0N_100plotRangeStart_4.0plotRangeEnd_8.0
    \includegraphics[width=0.5\textwidth]{validate_p_1.pdf}
...
We see that the peaks coincide with the zeros of the Bessel function. 
We see that the the spikes are smaller for the case PLUG IN HERE, but they are not fully gone.

\begin{figure}
    %MinimumSingularValuec_i3.0c_o1.0N_100eta1.0plotRangeStart_4.0plotRangeEnd_8.0
    \includegraphics[width=0.5\textwidth]{numRes1.pdf}
    %MinimumSingularValuec_i1.0c_o3.0N_100eta1.0plotRangeStart_4.0plotRangeEnd_8.0
    \includegraphics[width=0.5\textwidth]{numRes2.pdf}
    \caption{Minimum singular value of the matrix $diag(A_n)$ by wave number $\kappa$. 
    On the left side we have $c_i = 1, c_o = 3$ 
    and on the right plot we have $c_i = 3, c_o = 1.$}
   \label{fig:p_validation}
\end{figure}
